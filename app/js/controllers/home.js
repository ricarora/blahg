...
$http.get('https://blahg-api-app.herokuapp.com/posts')
...
$http.get('https://blahg-api-app.herokuapp.com/tags')
.success(function(data) {
  $scope.tags = data;
});
...
$scope.submitNewPost = function() {
  ...
  $http.post('https://blahg-api-app.herokuapp.com/posts',
    {
      post: {
...
$scope.toggleId = function(id) {
  ...
  // i will equal either the index of the item if it's in the array, or -1 if not
  if(i == -1) {
